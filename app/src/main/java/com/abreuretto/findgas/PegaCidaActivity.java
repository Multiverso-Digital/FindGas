...
public class PegaCidaActivity extends ListActivity implements FetchDataListener{
    ...
    private void initView() {
        ...
        sb.append("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + latx + "," + lonx + "&radius=5000&sensor=true&types=gas_station&key=AIzaSyBRhULv84uFwIW0JYyGonkTM5sr5dvOR9I");
        ...
        String url1 = "https://api.foursquare.com/v2/venues/search?ll=" + latx + "," + lonx + "&categoryId=4bf58dd8d48988d113951735&client_id=WYVK3C5JYYSKWLYKMHZFQUAGZYXRBAFXMLARQHLJBFFC05IX&client_secret=GJO5FLB20ZI03LLYBEBST55NI5OMLPG4IRIHXRBPLYB1S4M3&v="+datax+"&radius=5000";
        String url2 = "http://demo.places.nlp.nokia.com/places/v1/discover/explore?in=" + latx + "," + lonx + ";r=5000&tf=plain&pretty=y&app_id=al3SR82BNt_apHzbF-b9&app_code=oEW8ZxpiQU7lsr2XkYZAjg&cat=petrol-station";
