...
public class Yelp {
  ...
  public String searchCat(String term, double latitude, double longitude) {
	    OAuthRequest request = new OAuthRequest(Verb.GET, "http://api.yelp.com/v2/search");
	  ...
	  //  http://api.yelp.com/v2/search?category_filter=burgers,gluten_free&sort=1&radius_filter=1600&ll=33.7489954,-84.3879824
  ...
  public String searchrating(String term, double latitude, double longitude) {
	    OAuthRequest request = new OAuthRequest(Verb.GET, "http://api.yelp.com/v2/search");
	    request.addQuerystringParameter("term", term);
	    request.addQuerystringParameter("ll", latitude + "," + longitude);
	    request.addQuerystringParameter("sort", "2");
  ...
  public String detalhe(String term) {
	    OAuthRequest request = new OAuthRequest(Verb.GET, "http://api.yelp.com/v2/business/"+term);
	   // request.addQuerystringParameter("", term);
	    this.service.signRequest(this.accessToken, request);
	    Response response = request.send();
	    return response.getBody();
	  }
  ...
  public static void main(String[] args) {
    ...
    String token = "pK66jsMgWLUsft0dyX_SDNnTeUWV04iv";
    String tokenSecret = "HzR44n6PjYBfnRkGlU6_MGcIuxY";
